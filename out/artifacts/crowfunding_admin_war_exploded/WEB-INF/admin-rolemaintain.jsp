                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <tbody>
                            <c:if test="${empty rolePageInfo.list}">
                                <tr>
                                    <td colspan="6" style="text-align: center">抱歉！没有查询到相关数据！</td>
                                </tr>
                            </c:if>
                            <c:if test="${!empty rolePageInfo.list}">
                                <c:forEach items="${rolePageInfo.list}" var="role" varStatus="myStatus">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="http://localhost:8080/admin/update?id=${role.id}" class="btn btn-primary btn-xs">
